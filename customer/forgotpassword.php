...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['email'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        $conn->query("UPDATE customers SET reset_token='$token', token_expiration='$expiry' WHERE email='$email'");
        ...
        $resetLink = "http://localhost:8000/customer/resetpassword.php?token=$token";
        $mail->Body = "
