...
function generateChatbotResponse($message, $customer_id, $conn) {
    ...
    if (strpos($message, 'hello') !== false || strpos($message, 'hi') !== false || strpos($message, 'hey') !== false) {
        ...
        return "$first_name, you can reach our customer service team at +254-757196660 or via email at support@carrentals.com. Our office hours are Monday to Friday, 8 AM to 6 PM, and Saturday 9 AM to 3 PM.";
    }
    else {
...
if ($sender == 'admin') {
    ...
    header("Location: support_send.php");
}
exit();
?>